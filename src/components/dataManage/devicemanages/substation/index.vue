<!--
 * @Author: wangshiwei
 * @Date: 2025-04-17 11:18:16
 * @LastEditors: wangshiwei
 * @LastEditTime: 2025-04-18 10:34:59
 * @FilePath: \ahla-tkxt-web\src\components\dataManage\devicemanages\substation\index.vue
 * @Description: 广播分站
 * 
 *  
-->
      ...
      <div class="data_table">
        <el-table :data="filteredData" height="600">
          <el-table-column
            ...
            width="64"
          ></el-table-column>
          <el-table-column prop="name" label="设备名称" :show-overflow-tooltip="true" />
    ...
    >
      <el-form ref="dialogGroupRef" :model="formGrop" :rules="rules" label-width="100px">
        <el-form-item label="设备名称" prop="name">
          <el-input v-model="formGrop.name" placeholder="请输入设备名称" class="search_input" />
        </el-form-item>
        <el-form-item label="设备地址" prop="address">
          <el-input v-model="formGrop.address" placeholder="请输入地址" class="search_input" />
        </el-form-item>
