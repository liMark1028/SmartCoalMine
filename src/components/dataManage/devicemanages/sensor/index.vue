 ...
 * @LastEditTime: 2025-04-18 10:34:20
 * @FilePath: \ahla-tkxt-web\src\components\dataManage\devicemanages\sensor\index.vue
 * @Description: 传感器
 * 
 *  
-->
  ...
  <div class="sensor">
    ...
    <div class="sensor_contnet">
      <div class="data_table">
        <el-table :data="filteredData" height="600">
          ...
          <el-table-column prop="group" label="所属分站" :show-overflow-tooltip="true" />
    ...
    >
      <el-form ref="dialogGroupRef" :model="formGrop" :rules="rules" label-width="100px">
        ...
        <el-form-item label="所属分站" prop="belongsection">
          <el-select v-model="formGrop.group" placeholder="请选择所属分站" class="search_input" popper-class="custom-select-dropdown">
            <el-option
...
const filteredData = ref([
  { name: '一氧化碳', address: '1402运输顺槽皮带机头', group: '26号分站', belongsection: '350' },
  { name: '二氧化碳', address: '1403运输顺槽皮带机头', group: '5号分站', belongsection: '350' },
])
