 ...
 * @LastEditTime: 2025-04-18 10:36:08
 * @FilePath: \ahla-tkxt-web\src\components\dataManage\devicemanages\ventline\index.vue
 * @Description: 通风管路
 * 
 *  
-->
    ...
    >
      <el-form ref="dialogGroupRef" :model="formGrop" :rules="rules" label-width="100px">
        ...
        <el-form-item label="类型" prop="type">
          <el-select v-model="formGrop.type" placeholder="请选择类型" class="search_input" popper-class="custom-select-dropdown">
            <el-option
