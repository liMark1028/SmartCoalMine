 ...
 * @LastEditTime: 2025-04-18 10:35:32
 * @FilePath: \ahla-tkxt-web\src\components\dataManage\devicemanages\valve\index.vue
 * @Description: 阀门
 * 
 *  
-->
  ...
  <div class="valve">
    ...
    >
      <el-form ref="dialogGroupRef" :model="formGrop" :rules="rules" label-width="100px">
        ...
        <el-form-item label="状态" prop="belongsection">
          <el-select v-model="formGrop.status" placeholder="请选择状态" class="search_input" popper-class="custom-select-dropdown">
            <el-option
