 ...
 * @title: 智能变电站
 * @Autor: li yu mo
 * @Date: 2025-04-28 09:19:18
 * @LastEditors: li yu mo
 * @LastEditTime: 2025-04-28 11:22:23
 * @FilePath: \ahla-tkxt-web\src\views\MainWindow\comperhensive\belt\index.vue
-->
...
.substation {
  ...
  .content {
    height: 334px;
    background-image: url('@/assets/image/comperhensive/belt/content_bg.png');
